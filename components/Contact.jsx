...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "00643cac-af1a-4eb4-8091-6e9cddd73ce7");
  ...
  return (
    ...
    id='contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none'>
      ...
      I’d love to hear from you! If you have any questions, project inquiries, or feedback, feel free to reach out using the form below.</motion.p>
